...
/**
 * Plain Markdown generator. For generating md files ready for GitHub web view.
 *
 * @ingroup developer
 */
class PlainMarkdownGenerator {
public:
  /**
   * Constructor.
   *
   ...
   */
  PlainMarkdownGenerator(const std::filesystem::path& output);
